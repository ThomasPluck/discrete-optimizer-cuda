...
// if you want to use this, replace the arguments for the ints with an argument
// for an object of this type, then pass in *this to the kernel call in place of
// the ints
